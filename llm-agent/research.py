...
serper_api_key="e4d7a2fa0e17a8487e24a63bd3f570bb289f0ed5"
...
def scrape(url: str):
    ...
    post_url = f"http://127.0.0.1:3000/content"
...
#最初 需求  启动干活
user_proxy.initiate_chat(
    writing_assistant, message="write a blog about Intel TDX Technology")
